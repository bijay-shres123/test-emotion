...
import { Card, Form, Input, Typography, Button, Select, Space, InputNumber, message, Layout } from 'antd';
...
function EditQuestionPage() {
  ...
  const [redirectToQuestionList, setRedirectToQuestionList] = useState(false);
  ...
  const onSubmit = (formValues) => {
    ...
    dispatch(updateQuestion(id, formValues))
      .then(() => {
        ...
        setRedirectToQuestionList(true);
  ...
  if (redirectToQuestionList) {
    return <Navigate to="/admin/questionlist" />;
  }
